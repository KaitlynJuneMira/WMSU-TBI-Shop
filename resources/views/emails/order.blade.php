...
<head>
    ...
    <title>Order Confirmation - WMSU TBI Shop</title>
</head>
<body style="font-family: Arial, sans-serif;">
    ...
    <table style="width:700px;">
        ...
        <!-- <tr>
            <td>Download your order invoice <a href="{{ url('orders/invoice/download/'.$orderDetails['id'].'') }}">{{ url('orders/invoice/download/'.$orderDetails['id'].'') }}</a><br>
            (Copy & Paste to open if the link does not work)</td>
        </tr> -->
        <tr>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>Regards,<br>WMSU TBI Shop</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        </tr>
